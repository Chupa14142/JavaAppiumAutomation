...
public class WelcomePageObject extends MainPageObject {
    ...
    public void clickNextButton() {
        this.waitForElementPresentAndClick(NEXT_LINK,
                "Cannot find and click 'Next' link",10
        );
    }

    public void clickGetStartedButton() {
        this.waitForElementPresentAndClick(GET_STARTED_BUTTON,
                "Cannot find and click 'Get started",10
        );
    }

    public void clickSkip() {
        this.waitForElementPresentAndClick(SKIP,"Cannot find and click Skip button");
    }
